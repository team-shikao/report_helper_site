...
<header class="{scroll_y > 10 ? '' : 'bgOFF'} {$page.route.id === "/" ? '' : 'notTop'}">
    <a href="/" class="pageTitle {$page.route.id === "/" ? '' : 'notTop'}">レポートお助け君</a>
    <div id="headerLinks">
        <a
            href="/how-to/use"
...
<style>
    ...
    header.notTop {position: relative;}
    header a.pageTitle {
    ...
    header a.pageTitle.notTop {color: #121212;}
